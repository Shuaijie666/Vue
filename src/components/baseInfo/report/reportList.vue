<template>
	<div>
		...
		<div style="text-align: left;margin:0 0 20px 50px;">
			<el-input style='width:160px' placeholder='船队名字' v-model='search_reportname'></el-input>
		...
		<center>
			<el-table :data="list">
				...
				<el-table-column prop="flowid" label="流程" width="180"></el-table-column>
	...
	export default {
		...
		methods:{
			...
			search(){
				...
				// 传递给后端的数据
				var data = {shipname:this.search_reportname};
				this.$axios.post(url,this.$qs.stringify(data),{
					headers: {
						'Content-Type':'application/x-www-form-urlencoded; charset=UTF-8'
					}
